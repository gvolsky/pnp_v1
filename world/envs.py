...
class OnePlayerEnv:
    ...
    def step(self, actions):
        ...
        info = {
            ...
            "eated_on_step": copy.deepcopy(self.realm.eated_on_step),
            "all_eated": copy.deepcopy(self.realm.all_eated),
            "true_action": copy.deepcopy(self.realm.true_action),
            "step": self.realm.step_num,
        }
